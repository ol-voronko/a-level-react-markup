...
const SliderImage = ({ img }) => <img className="slider-img" src={img} />;
const AboutSection = () => (
  <section className="about-section">
    <div className="about-section-text">
      ...
      <p>
        ...
        voluptate quidem, explicabo asperiores libero inventore veritatis natus,
        placeat dignissimos in laborum eius quae numquam voluptates provident
        voluptatibus fugiat maiores. Error recusandae eos provident explicabo
        iure quas cum quaerat, asperiores veritatis! Repellendus autem laborum
        aliquid? Error velit sit soluta earum, provident, voluptates molestias
        quod voluptate suscipit nihil omnis vero ducimus reiciendis.
      </p>
    </div>
    ...
    <div className="footering">
      <div className="about">
        ...
        <p>
          ...
          Eaque ad, doloribus itaque sequi minus quidem laudantium optio placeat
      ...
      <div className="contact">
        <div>
          ...
          <address>
            <p>
              <i className="fa fa-location-dot"></i> 5419 Joseph Mountains
              <br />
              Apt.716
            </p>
      ...
      <address>
        <div className="email">
          <a href="mailto:joga.info@example.com">
            <i className="fa fa-envelope"></i> joga.info@example.com
          </a>
          <a href="http://www.example.com">
            <i className="fa-solid fa-globe"></i>www.example.com
          </a>
        </div>
      </address>
    </div>
